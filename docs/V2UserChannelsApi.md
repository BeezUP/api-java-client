...
//import io.swagger.client.api.V2UserChannelsApi;
...
V2UserChannelsApi apiInstance = new V2UserChannelsApi();
...
try {
    ...
    System.err.println("Exception when calling V2UserChannelsApi#getChannelCategories");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling V2UserChannelsApi#getChannelColumns");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling V2UserChannelsApi#getChannelInfo");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling V2UserChannelsApi#getCurrentChannels");
    e.printStackTrace();
}
```
