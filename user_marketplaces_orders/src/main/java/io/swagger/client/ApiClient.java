...
public class ApiClient {
    ...
    private String basePath = "https://api.beezup.com/v2/user/marketplaces/orders";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.beezup.com/v2/user/marketplaces/orders
