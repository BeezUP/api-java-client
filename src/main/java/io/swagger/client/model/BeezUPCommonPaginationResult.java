...
public class BeezUPCommonPaginationResult {
   ...
   * @return entryCount
  **/
  @ApiModelProperty(example = "25", required = true, value = "The entry count currently returned")
   ...
   * @return pageCount
  **/
  @ApiModelProperty(example = "38", required = true, value = "The page count")
  ...
  **/
  @ApiModelProperty(example = "943", required = true, value = "The total entry count")
