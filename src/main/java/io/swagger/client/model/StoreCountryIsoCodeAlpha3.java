 ...
 */
@ApiModel(description = "The country iso code alpha 3 based on the list of values /user/lov/StoreCountry")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2017-05-04T14:19:57.195Z")
public class StoreCountryIsoCodeAlpha3 {
  ...
  public String toString() {
    ...
    sb.append("class StoreCountryIsoCodeAlpha3 {\n");
