 ...
 */
@ApiModel(description = "Indicate the url of your picture profil based on gravatar")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2017-05-05T12:58:38.338Z")
public class GravatarProfilePictureUrl {
  ...
  public String toString() {
    ...
    sb.append("class GravatarProfilePictureUrl {\n");
