 ...
 */
@ApiModel(description = "The encrypted XML Blockly representation of the expression")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2017-05-05T11:50:41.747Z")
public class EncryptedBlocklyExpression {
  ...
  public String toString() {
    ...
    sb.append("class EncryptedBlocklyExpression {\n");
